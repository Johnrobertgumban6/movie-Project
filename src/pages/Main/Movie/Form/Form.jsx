  ...
  const handleSearch = useCallback(() => {
    axios({
      ...
      headers: {
        Accept: 'application/json',
        Authorization:
        'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI3YWY2YTFjZmUxNDU5NDQzZDc2NTUxNGZmNDE4MmE2NSIsIm5iZiI6MTczMTY1MTQzNS44NTYzMDQsInN1YiI6IjY3MzZjZWU5Y2U0OTQxMDAzMmMxZTZmZCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.nIxa8fuhnXj2f4NXnANx9m4Ts757PnK_YkN9FJTNwNg',
      },
    }).then((response) => {
      setSearchedMovieList(response.data.results);
