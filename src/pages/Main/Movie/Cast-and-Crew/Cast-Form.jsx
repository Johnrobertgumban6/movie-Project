...
function CastForm() {
  ...
  function importDataCast() {
    axios({
      ...
      headers: {
        Accept: 'application/json',
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIwMmM5MWJlYTQ0MTdhOTUyOTI3MzUyMmQ1MzYzZTBhYyIsIm5iZiI6MTczMzM3MTIzMS44MjcwMDAxLCJzdWIiOiI2NzUxMjU1ZjkwYWEwMjZiOWRhZWRhNTEiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.nZvHGyQcyuFr8aZEE21RWyNz-PToYp12mMcseZZXm2M', // Make sure to replace this with your actual API key
      },
    }).then((response) => {
  ...
  const handleSearchPerson = useCallback(async (page = 1) => {
    ...
    try {
      ...
      const response = await axios({
        ...
        headers: {
          accept: 'application/json',
          Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIwMmM5MWJlYTQ0MTdhOTUyOTI3MzUyMmQ1MzYzZTBhYyIsIm5iZiI6MTczMzM3MTIzMS44MjcwMDAxLCJzdWIiOiI2NzUxMjU1ZjkwYWEwMjZiOWRhZWRhNTEiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.nZvHGyQcyuFr8aZEE21RWyNz-PToYp12mMcseZZXm2M'
        },
      });
